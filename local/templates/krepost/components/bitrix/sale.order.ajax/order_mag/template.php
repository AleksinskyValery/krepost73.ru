...
<!--	MAIN BLOCK	-->
	<div class="col-md-9 col-sm-8 bx-soa">
		...
		<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
			<div class="bx-soa-section-title-container">
				<h2 class="bx-soa-section-title col-sm-9 col-xs-8">
		...
		<? if (!isset($arParams['BASKET_POSITION']) || $arParams['BASKET_POSITION'] == 'before'): ?>
			...
			<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
				<div class="bx-soa-section-title-container">
					...
					<div class="col-xs-4 col-sm-3 text-right"><a href="javascript:void(0)" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
				</div>
				<div class="bx-soa-section-content container-fluid"></div>
			</div>
		<? endif ?>
		...
		<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
			<div class="bx-soa-section-title-container">
				...
				<div class="col-xs-4 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
			</div>
			<div class="bx-soa-section-content container-fluid"></div>
		</div>
	...
	false
			...
			<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn_blue">
				<?=$arParams['MESS_ORDER']?>
			</a>
		</div>
	...
	<!--	SIDEBAR BLOCK	-->
	<div id="bx-soa-total" class="col-md-3 col-sm-4 bx-soa-sidebar">
