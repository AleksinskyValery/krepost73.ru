...
toggleTabs({
    tabParentSelector: '.delivery__tabheader-list',
   tabHeaderSelector: '.delivery__tabheader-item',
   tabHeaderActiveClass: 'delivery__tabheader-item_active',
   tabItemSelector: '.delivery__tabcontent-item',
   tabItemActiveClass: 'delivery__tabcontent-item_active',
   event: 'click',
});
}