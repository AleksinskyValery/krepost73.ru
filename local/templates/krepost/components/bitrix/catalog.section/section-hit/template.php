...
<!--<div class="d-flex justify-content-between flex-wrap"><div>
    ...
    <div class="select">
        <div class="select__header">
            <span class="select__current">цена по убыванию</span>
        </div>
        <ul class="select__body">
            <li class="select__item">цена по убыванию</li>
            <li class="select__item">цена по возрастанию</li>
							...
							case 9:
								foreach ($rowItems as $item)
								{
									...
									<div class="col product-item-line-card">
										<? $APPLICATION->IncludeComponent('bitrix:catalog.item', 'item', array(
												'RESULT' => array(
													'ITEM' => $item,
													'AREA_ID' => $areaIds[$item['ID']],
													'TYPE' => $rowData['TYPE'],
