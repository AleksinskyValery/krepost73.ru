...
<? } ?>
	...
	if ($_REQUEST["filter_history"] !== 'Y')
	{
		...
		foreach ($arResult['ORDERS'] as $key => $order)
		{
			...
			if (false && $orderHeaderStatus !== $order['ORDER']['STATUS_ID'])
			{
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 sale-order-list-title-container">
                                            <a class="link_about" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
						<h2 class="sale-order-list-title">
							...
							<?=$order['ORDER']['FORMATED_PRICE']?>
                                                ...
                                                <span class="sale-order-list-about-link"><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span>
                                            </a>    
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-container">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
										<div class="sale-order-list-payment-title">
											...
											?>
                                                                                        ...
                                                                                        <span class="sale-order-list-payment-title_name"><?=Loc::getMessage('SPOL_TPL_PAYMENT')?>:</span>
                                                                                            <span class="sale-order-list-payment-title-element"><?=$payment['PAY_SYSTEM_NAME']?></span>
                                                                                        </div>
                                                                                        <div class="status_payment">
                                                                                            <span class="sale-order-list-payment-title_name"></span>
											<?
											if ($payment['PAID'] === 'Y')
											{
												?>
										...
										<div class="sale-order-list-payment-price">
                                                                                    <div class="status_payment">
											<span class="sale-order-list-payment-title_name sale-order-list-payment-element"><?=Loc::getMessage('SPOL_TPL_SUM_TO_PAID')?>:</span>
									...
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
									{
										...
										else
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="btn btn_green sale-order-list-button ajax_reload" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
								...
								<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-shipment">
									...
									<span class="sale-order-list-shipment-element">
										...
										?>
                                                                            ...
                                                                            <div class="status_payment">
                                                                                <span class="sale-order-list-payment-title_name">
                                                                                    <?=Loc::getMessage('SPOL_TPL_DELIVERY_COST');?>:
                                                                                </span>
										...
										if ($shipment['DEDUCTED'] == 'Y')
										{
											?>
                                                                                        <div class="status_payment">
                                                                                            <span class="sale-order-list-payment-title_name">
                                                                                                <?=Loc::getMessage('STATUS_SHIPMENT');?>:
                                                                                            </span>
									...
									<div class="status_payment sale-order-list-shipment-status">
										<span class="sale-order-list-payment-title_name sale-order-list-shipment-status-item"><?=Loc::getMessage('SPOL_ORDER_SHIPMENT_STATUS');?>:</span>
									...
									{
										?>
										<div class="status_payment sale-order-list-shipment-item">
                                                                                    <span class="sale-order-list-payment-title_name">
						...
						<div class="sale-order-list-inner-row">
							...
							<div class="sale-order-list-repeat-container">
								<a class="btn btn_blue sale-order-list-repeat-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>"><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></a>
							</div>
							<? } ?>
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				<div class="row">
					...
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							<div class="col-md-6 col-sm-12 sale-order-list-accomplished-date-container">
								<?
								if ($_REQUEST["show_canceled"] !== 'Y')
								{
									?>
								...
								<span class="sale-order-list-accomplished-date-number"><?= $order['ORDER']['DATE_STATUS_FORMATED'] ?></span>
                                                        ...
                                                        <div class="col-md-6 col-sm-12 sale-order-list-repeat-accomplished">
