...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input class="forgot_pass_input" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" />
				<input type="hidden" name="USER_EMAIL" />
				<input type="submit" class="btn btn_blue" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
			</div>
		</div>
